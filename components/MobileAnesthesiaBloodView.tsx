...
export const MobileAnesthesiaBloodView: React.FC<MobileAnesthesiaBloodViewProps> = ({
  ...
  if (!currentPatient) {
    return (
      <div className="p-4 text-center text-[#9a9ea6]">
  ...
  return (
    <div className="w-full max-w-full sm:max-w-md mx-auto glass-panel text-[#1a1a1a] rounded-2xl border-black/10 shadow-2xl overflow-hidden overflow-x-clip font-sans min-w-0 break-words">
      ...
      <div className="bg-white border-b border-black/10 p-3.5 sm:p-4 min-w-0 max-w-full overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2.5">
          <div className="flex items-center gap-2 min-w-0">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg border border-black/10 bg-black/[0.04] text-[#1a1a1a] font-bold shadow-md shrink-0">
              <Droplets className="h-4 w-4" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <span className="text-xs font-bold text-[#1a1a1a] tracking-tight uppercase truncate">
                  In-OT Blood View
                </span>
                <span className="inline-block h-2 w-2 rounded-full bg-emerald-400 shrink-0" />
              </div>
              <span className="text-[10px] text-[#6b706b] font-mono block truncate">
          ...
          <select
            ...
            className="rounded border border-black/10 bg-white px-2 py-1 text-[11px] font-bold text-[#1a1a1a] focus:outline-none shrink-0 max-w-[140px]"
          >
            {patients.map((p) => (
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <h3 className="font-serif text-sm font-bold text-[#1a1a1a] truncate">{currentPatient.name}</h3>
                <span className="rounded bg-white px-1.5 py-0.2 text-[10px] font-bold text-[#3f4440] border border-black/10 shrink-0">
                  {currentPatient.asaStatus}
                </span>
              </div>
              <p className="text-[11px] text-[#6b706b] font-mono truncate">
                {currentPatient.mrn} · {currentPatient.age}y {currentPatient.gender}
              </p>
              <p className="text-[10px] text-[#6b706b] truncate">
      ...
      {/* View Tabs */}
      <div role="tablist" aria-label="In-OT demo views" className="grid grid-cols-3 border-b border-black/10 bg-white text-center min-w-0 max-w-full overflow-hidden">
        <button
          type="button"
          role="tab"
          ...
          className={
            ...
            (activeTab === 'STAT_LABS'
              ? 'border-sky-300 text-[#1a1a1a] bg-sky-400/10'
              : 'border-transparent text-[#6b706b] hover:text-[#1a1a1a]')
          }
        >
          <Droplets className="h-3.5 w-3.5 shrink-0" aria-hidden="true" />
          <span className="hidden xs:inline">STAT Labs</span><span className="xs:hidden">Labs</span>
        </button>
        <button
          type="button"
          role="tab"
        ...
        >
          ...
          <span className="hidden xs:inline">Med History</span><span className="xs:hidden">History</span>
        </button>
        <button
          type="button"
          role="tab"
        ...
        >
          ...
          <span className="hidden xs:inline">NPO / Holds</span><span className="xs:hidden">NPO</span>
        </button>
      </div>
        ...
        <div className="p-3.5 space-y-2.5">
          ...
          <div className="veracity-well rounded-xl p-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-xs font-bold text-[#1a1a1a]">Serum Potassium (K⁺)</span>
                  <div className="text-[10px] text-[#6b706b]">Ref: 3.5 – 5.0 mEq/L</div>
                </div>
              </div>
              ...
              <div className="text-right">
                <div className="text-base font-black text-[#1a1a1a]">
                  {potassiumLab.value}{' '}
                  <span className="text-[10px] font-normal text-[#6b706b]">mEq/L</span>
                </div>
                <span
                  className={
            ...
            <p className="mt-2 text-[11px] text-[#6b706b] border-t border-black/10 pt-1.5 font-mono">
          ...
          <div className="veracity-well rounded-xl p-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-xs font-bold text-[#1a1a1a]">Hemoglobin (Hb)</span>
                  <div className="text-[10px] text-[#6b706b]">
              ...
              <div className="text-right">
                <div className="text-base font-black text-[#1a1a1a]">
                  {hemoglobinLab.value}{' '}
                  <span className="text-[10px] font-normal text-[#6b706b]">g/dL</span>
                </div>
                <span
                  className={
                    'px-2 py-0.5 rounded text-[9px] font-bold ' +
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 min-w-0">
            ...
            <div className="veracity-well rounded-xl p-2.5">
              <div className="text-[11px] font-bold text-[#6b706b]">Platelets (PLT)</div>
              <div className="text-sm font-black text-[#1a1a1a] mt-0.5">
                {plateletsLab.value}{' '}
                <span className="text-[9px] font-normal text-[#6b706b]">k/µL</span>
              </div>
              <div className="text-[10px] text-[#1c7a3d] font-semibold mt-1">
                ✓ ASRA Neuraxial OK
              </div>
            </div>
            ...
            {/* PT / INR */}
            <div className="veracity-well rounded-xl p-2.5">
              <div className="text-[11px] font-bold text-[#6b706b]">Coagulation (INR)</div>
              <div className="text-sm font-black text-[#1a1a1a] mt-0.5">
                {inrLab.value}{' '}
                <span className="text-[9px] font-normal text-[#6b706b]">INR</span>
              </div>
              <div className="text-[10px] text-[#1c7a3d] font-semibold mt-1">
                ✓ Regional Block OK
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 min-w-0">
            {/* Creatinine */}
            <div className="veracity-well rounded-xl p-2.5">
              <div className="text-[11px] font-bold text-[#6b706b]">Creatinine / eGFR</div>
              <div className="text-sm font-black text-[#1a1a1a] mt-0.5">
                {creatinineLab.value}{' '}
                <span className="text-[9px] font-normal text-[#6b706b]">mg/dL</span>
              </div>
              <div
                className={
            ...
            >
              <div className="text-[11px] font-bold text-[#6b706b]">hs-Troponin I</div>
              <div className="text-sm font-black text-[#1a1a1a] mt-0.5">
                {troponinLab.value}{' '}
                <span className="text-[9px] font-normal text-[#6b706b]">ng/mL</span>
              </div>
              <div
                className={
                  'text-[10px] font-semibold mt-1 ' +
              ...
              {tropEval.severity !== 'GREEN' && (
                <p className="mt-1 text-[10px] leading-snug text-[#6b706b]">{tropEval.directive}</p>
              )}
            </div>
          </div>

          {/* Blood Bank Strip */}
          <div className="rounded-xl border border-black/10 bg-black/[0.03] p-2.5 flex flex-wrap items-center justify-between gap-2 min-w-0 break-words">
            <div className="flex items-center gap-2">
              <div className="flex h-6 w-6 items-center justify-center rounded border border-black/10 bg-black/[0.04] text-[#1a1a1a] font-black text-xs">
                {bloodBankData.bloodGroup}
              </div>
              <div>
                <span className="text-xs font-bold text-[#1a1a1a]">Blood Bank Status</span>
                <p className="text-[10px] text-[#6b706b]">
      ...
      {activeTab === 'CLINICAL_HISTORY' && (
        <div className="p-3.5 space-y-2.5 text-xs">
          {(() => {
            ...
            return (
              <div className="rounded-xl border border-rose-500/40 bg-rose-950/40 p-3 space-y-1">
                <div className="font-bold text-[#b3261e] flex items-center gap-1.5">
                  <AlertOctagon className="h-4 w-4" />
                  <span>DO NOT CLEAR — doctor fitness pending</span>
                </div>
                {pending.map((r) => (
                  <p key={r.id} className="text-[#b3261e] text-[11px]">
          ...
          <div className="veracity-well rounded-xl p-3 space-y-1">
            <div className="flex items-center justify-between font-bold text-[#1c7a3d]">
              <span className="flex items-center gap-1.5">
                <Pill className="h-4 w-4" />
                <span>Contraceptive / Hormone Status:</span>
              </span>
              <span className="rounded bg-white px-2 py-0.5 text-[9px] font-bold text-[#1a1a1a] border border-black/10">
                {q
            ...
            <p className="text-[#3f4440] text-[11px]">
              {q
            ...
            {currentPatient.questionnaireUpdatedAtIso ? (
              <p className="text-[10px] font-mono text-[#6b706b]">
                Synced{' '}
                {new Date(
          ...
          <div className="veracity-well rounded-xl p-3 space-y-1">
            <div className="flex items-center justify-between font-bold text-[#1a1a1a]">
              ...
              <span className="rounded bg-white px-2 py-0.5 text-[9px] font-bold text-[#3f4440] border border-black/10">
                {q && q.medicalIssues && q.medicalIssues.length > 0
                  ? `${q.medicalIssues.length} flagged`
                  : 'None reported'}
              </span>
            </div>
            <p className="text-[#6b706b] text-[11px]">
              {q && q.medicalIssues && q.medicalIssues.length > 0
          ...
          <div className="veracity-well rounded-xl p-3 space-y-1">
            <div className="flex items-center justify-between font-bold text-[#7a5200]">
              <span className="flex items-center gap-1.5">
          ...
          {onOpenQuestionnaire && (
            <button
              ...
              className="veracity-press w-full py-2.5 rounded-xl bg-white hover:bg-black/[0.04] border border-black/10 text-[#1a1a1a] font-bold text-xs cursor-pointer"
            >
      ...
      {activeTab === 'NPO_MEDS' && (
        <div className="p-3.5 space-y-2.5 text-xs">
          ...
          <div className="veracity-well rounded-xl p-3 space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-center min-w-0">
              <div className="p-2 rounded-lg bg-white border border-black/10">
                <div className="text-[10px] text-[#6b706b]">Solids Fasting</div>
                <div className="text-sm font-black text-[#1c7a3d] mt-0.5">
                  {q?.lastSolidFoodHoursAgo ?? 12}h 00m
                </div>
              </div>
              <div className="p-2 rounded-lg bg-white border border-black/10">
                <div className="text-[10px] text-[#6b706b]">Clear Fluids</div>
                <div className="text-sm font-black text-[#1c7a3d] mt-0.5">
                  {q?.lastClearFluidHoursAgo ?? 4}h 15m
                </div>
              </div>
            </div>
            <p className="text-[11px] text-[#3f4440]">
          ...
          <div className="rounded-xl border border-black/10 bg-white p-2.5 text-[11px] space-y-1">
            <p className="text-rose-400 font-bold">
              ✕ Do NOT take diabetes medicine on day of surgery.
            </p>
            <p className="text-[#1c7a3d] font-bold">
          ...
          <div className="space-y-1.5">
            <span className="font-bold text-[11px] text-[#6b706b] uppercase tracking-wider">
            ...
            {currentPatient.medications.map((med) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="font-bold text-[#1a1a1a] text-xs break-words">{med.drugName}</div>
      ...
      <div className="p-4 bg-white border-t border-black/10 space-y-2">
        {clearedNotice && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 min-w-0">
          <button
            ...
            className="veracity-press flex items-center justify-center gap-1.5 rounded-full bg-[#1a1a1a] hover:bg-black/80 text-white py-3 px-3 text-xs font-bold shadow-md cursor-pointer min-h-[46px]"
          >
          ...
          <button
            ...
            className="veracity-press flex items-center justify-center gap-1.5 rounded-xl bg-white hover:bg-black/[0.04] border border-black/10 text-[#1a1a1a] py-3 px-3 text-xs font-bold cursor-pointer min-h-[46px]"
          >
            <Share2 className="h-4 w-4 text-[#1c7a3d]" />
